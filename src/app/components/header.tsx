    ...
    return (
        <div className="pt-6 container header flex items-center justify-between fixed top-0 left-0 right-0 w-full bg-transparent px-4 md:px-0">
            ...
            <div className="col-3 flex gap-8">
                <Image alt="" className={`${props.backgroundColor === "#1f2128" ? "iconWhite" : ""} cursor-pointer`} src={"/images/search.svg"} width={24} height={1}></Image>
                <Image alt="" className={`${props.backgroundColor === "#1f2128" ? "iconWhite" : ""} cursor-pointer`} src={"/images/cart.svg"} width={24} height={1}></Image>
                <Image alt="" className={`${props.backgroundColor === "#1f2128" ? "iconWhite" : ""} cursor-pointer`} src={"/images/user.svg"} width={24} height={1}></Image>
            </div>
        </div>
    );
}
